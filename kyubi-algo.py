...
#             child.chakra = decay
#             print(f"{ninja.name} membagikan {decay} chakra ke {child.name}")
...
# root_chakra = int(input(f"Masukkan jumlah chakra {root_name} : "))
# root = Ninja(root_name, root_chakra)
# all_ninja.append(root)

# n = int(input("Berapa banyak ninja yang akan ditambahkan? : "))
# for _ in range(n):
#     parent_name = input("Masukkan nama pemberi chakra : ")
#     child_name = input("Masukkan nama penerima chakra : ")
    
#     parent = find_ninja(parent_name, all_ninja)
#     if parent is None:
#         parent = Ninja(parent_name)
#         all_ninja.append(parent)
...
# decay = int(input("Masukkan jumlah chakra yang akan dibagikan : "))
# share_chakra(root, decay)
# print("\nJumlah chakra setiap ninja:")
# show_chakra(root)        
...
# n = int(input("Berapa banyak ninja yang akan menerima chakra langsung dari root?: "))
# for _ in range(n):
